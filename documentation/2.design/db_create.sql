...
CREATE TABLE IF NOT EXISTS `ngoa`.`contacttype` (
  `idcontacttype` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `typecode` VARCHAR(45) NOT NULL COMMENT '',
  `typename` VARCHAR(45) NOT NULL COMMENT '',
  `description` VARCHAR(45) NULL COMMENT '',
  `priority` TINYINT NULL COMMENT '',
  `retired` TINYINT(1) NULL COMMENT '',
  PRIMARY KEY (`idcontacttype`)  COMMENT '',
  UNIQUE INDEX `typename_UNIQUE` (`typename` ASC)  COMMENT '',
  UNIQUE INDEX `typecode_UNIQUE` (`typecode` ASC)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `ngoa`.`department`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ngoa`.`department` ;

CREATE TABLE IF NOT EXISTS `ngoa`.`department` (
  `iddepartment` INT NOT NULL COMMENT '',
  `typecode` VARCHAR(45) NOT NULL COMMENT '',
  `typename` VARCHAR(45) NOT NULL COMMENT 'department name',
  `description` VARCHAR(45) NULL COMMENT '',
  `priority` VARCHAR(45) NULL COMMENT '',
  `retired` TINYINT(1) NULL COMMENT '',
  PRIMARY KEY (`iddepartment`)  COMMENT '',
  UNIQUE INDEX `typename_UNIQUE` (`typename` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ngoa`.`contact` (
  `idcontact` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `contacttype_idcontacttype` INT NOT NULL COMMENT '',
  `username` VARCHAR(45) NOT NULL COMMENT '	',
  `password` VARCHAR(45) NOT NULL COMMENT '',
  `userlocale` VARCHAR(45) NULL COMMENT 'for future use',
  `usersetting` VARCHAR(45) NULL COMMENT 'for future use',
  `retired` TINYINT(1) NULL COMMENT '',
  `department_iddepartment` INT NOT NULL COMMENT '',
  PRIMARY KEY (`idcontact`)  COMMENT '',
  INDEX `fk_contact_contacttype1_idx` (`contacttype_idcontacttype` ASC)  COMMENT '',
  INDEX `fk_contact_department1_idx` (`department_iddepartment` ASC)  COMMENT '',
  CONSTRAINT `fk_contact_contacttype1`
    FOREIGN KEY (`contacttype_idcontacttype`)
    REFERENCES `ngoa`.`contacttype` (`idcontacttype`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_contact_department1`
    FOREIGN KEY (`department_iddepartment`)
    REFERENCES `ngoa`.`department` (`iddepartment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ngoa`.`tasktype` (
  ...
  `typename` VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `ngoa`.`meetings` (
  ...
  INDEX `fk_meetings_contact1_idx` (`contact_idcontact` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_meetings_meetingstype1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_meetings_contact1`
...
-- -----------------------------------------------------
-- Table `ngoa`.`contactinfo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ngoa`.`contactinfo` ;

CREATE TABLE IF NOT EXISTS `ngoa`.`contactinfo` (
  `idcontactinfo` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `contact_idcontact` INT NOT NULL COMMENT '',
  `firstname` VARCHAR(45) NULL COMMENT '',
  `secondname` VARCHAR(45) NULL COMMENT '',
  ...
  INDEX `contact_idcontact_idx` (`contact_idcontact` ASC)  COMMENT '',
  PRIMARY KEY (`idcontactinfo`)  COMMENT '',
  CONSTRAINT `contact_idcontact`
    FOREIGN KEY (`contact_idcontact`)
    REFERENCES `ngoa`.`contact` (`idcontact`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
